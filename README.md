This repo contains an example of using Polars to analyze LODES data from the US Census. It's intended for data scientists curious about switching from Pandas to Polars.
